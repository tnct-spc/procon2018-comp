...
def raw_field_neural():
    ...
    network.calc_neural([500, 1], train_data, test_data, const.result_path + '_raw_field/', '_raw_field', int(min(500, train_size * 0.1)), int(min(300, train_size * 0.05)), const.epoch)
