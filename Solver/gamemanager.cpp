...
#include "catchPythonsAnswer/catchpythonsanswer.h"
...
void GameManager::startSimulation(QString my_algo, QString opponent_algo,QString InputMethod) {
    ...
    } else if (QString::compare("CatchPythonsAnswer", my_algo) == 0) {
        team_1 = std::make_shared<catchPythonsAnswer>(*field, field->getFinalTurn(), 0);
    }
    ...
    } else if (QString::compare("CatchPythonsAnswer", opponent_algo) == 0) {
        team_2 = std::make_shared<catchPythonsAnswer>(*field, field->getFinalTurn(), 1);
    }
