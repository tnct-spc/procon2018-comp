...
public:
    ...
    void startSimulation(QString my_algo, QString opponent_algo, QString InputMethod, std::vector<std::pair<QString, double>> my_params, std::vector<std::pair<QString, double>> opp_params, int finalTurn);
